...

{
    type: 'input',
    name: 'activity',
    message: 'What are you up to? (Required)' 
}   
];
...
const init = mdData => {
    ...
    // use the inputs to run the generation function and spit out a new file
    .then((answers) => {
        const mdContent = writeToFile(mdData)
...
// uses data from mdContent to write file
